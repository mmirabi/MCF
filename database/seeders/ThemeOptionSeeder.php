...
class ThemeOptionSeeder extends BaseSeeder
{
    public function run(): void
    {
        ...
        $data = [
            'site_title' => 'MedyaNossa - Laravel Ecommerce system',
            'seo_description' => 'MedyaNossa is a modern and flexible Multipurpose Marketplace Laravel script. This script is suited for electronic, organic and grocery store, furniture store, clothing store, hitech store and accessories store… With the theme, you can create your own marketplace and allow vendors to sell just like Amazon, Envato, eBay…',
            'copyright' => sprintf('©%s MedyaNossa. All Rights Reserved.', Carbon::now()->format('Y')),
