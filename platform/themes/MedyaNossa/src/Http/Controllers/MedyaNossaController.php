...
namespace Theme\MedyaNossa\Http\Controllers;
...
use Theme\MedyaNossa\Http\Requests\ContactSellerRequest;
use Theme\MedyaNossa\Supports\Wishlist;

class MedyaNossaController extends PublicController
{
