                    ...
                    switch ($promotion->target) {
                        ...
                        case DiscountTargetEnum::PRODUCT_COLLECTIONS:
                            ...
                            foreach ($cartItems as $item) {
                                ...
                                if (
                                    $item->qty >= $promotion->product_quantity &&
                                    array_intersect($product->original_product->productCollections->pluck('id')->all(), $promotion->productCollections()->pluck('id')->all())
                                ) {
                                    $promotionDiscountAmount += $promotion->value;
                                }
                            }
                        ...
                        case DiscountTargetEnum::PRODUCT_CATEGORIES:
                            ...
                            foreach ($cartItems as $item) {
                                ...
                                if (
                                    $item->qty >= $promotion->product_quantity &&
                                    array_intersect($product->original_product->categories->pluck('id')->all(), $promotion->productCategories()->pluck('id')->all())
                                ) {
                                    $promotionDiscountAmount += $promotion->value;
                                }
                            }
                    ...
                    switch ($promotion->target) {
                        ...
                        case DiscountTargetEnum::PRODUCT_CATEGORIES:
                            ...
                            foreach ($cartItems as $item) {
                                ...
                                if (
                                    $item->qty >= $promotion->product_quantity &&
                                    array_intersect($promotion->productCategories()->pluck('id')->all(), $product->original_product->categories->pluck('id')->all())
                                ) {
                                    $promotionDiscountAmount += $item->price * $promotion->value / 100;
                                }
                            }
